...
similarity5 = SimilarItem(target, dataset,
                          K)  # принимает на вход целевой эмбеддинг для которого нужно посчитать похожие изображения
...
similar_visual(similarity5,
               'img_path')  # визуализация на вход топ k похожих вместе с путем и классом и название столбца
